...
/* Override Streamlit's default red/primary accent with purple for sliders & interactive */
:root {
    --primary-color: #7B2D8B !important;
}
.stSlider [data-baseweb="slider"] [role="slider"] {
    background-color: #7B2D8B !important;
    border-color: #7B2D8B !important;
}
/* Thumb value label (the number shown above the thumb) */
.stSlider [data-baseweb="slider"] div[data-testid="stThumbValue"] {
    color: #7B2D8B !important;
}
.stSlider [data-baseweb="slider"] div[data-testid="stThumbValue"] p {
    color: #7B2D8B !important;
}
/* All text inside slider components */
.stSlider p {
    color: #7B2D8B !important;
}
/* The filled track */
...
/* Catch-all for any span/div showing the current value */
