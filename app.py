...
if page == "Project Creator":
    st.markdown('<div class="panel"><div class="panel-title">Project Creator</div><div class="panel-sub">Start with your project — AIcrete recommends a mix, runs all predictions, and gives you a clear GO / REVIEW / STOP decision.</div></div>', unsafe_allow_html=True)
        ...
        if not proj_name:
            ...
            with st.spinner("Running all predictions..."):
                ...
                st.session_state.v3_result = {
                    ...
                    "first_crack": fcrack, "residual_f150": f150, "strain_capacity": strain,
