...
def cost_calc(inputs):
    ...
    material_cost = (0.10 * cement + 0.55 * scm + 0.001 * water +
                     4.00 * sp + 1.75 * fibre + 0.15 * aggregate)
...
with st.sidebar:
    ...
    if "legal_page" in st.query_params:
        ...
        page = st.radio(
            "Navigation",
            ["Project Creator", "Compressive Strength", "Fresh-State Workability", "Durability & Service Life", "History", "Benchmarking", "Mix Optimizer", "Sensitivity Analysis", "SHAP Analysis", "Report", "Model Transparency"]
        )
